...
@click.command(name='pioneer-train-kinem')
...
def cli_pioneer_train_kinem(experiment: str, checkpoint_freq: int, num_samples: int, num_workers: int, no_monitor: bool):
    ...
    df = knm_train(results_dir=experiment_dir,
...
if __name__ == '__main__':
    try:
        cli.add_command(cli_pioneer_train_kinem)
